...
constexpr float MODEL_AXIS_X_METTERS = 0.15;
constexpr float MODEL_AXIS_Y_METTERS = 0.25;
...
constexpr float PERSON_HEAD_X_AXIS_METTERS = MODEL_AXIS_X_METTERS;
constexpr float PERSON_HEAD_Y_AXIS_METTERS = MODEL_AXIS_Y_METTERS;
